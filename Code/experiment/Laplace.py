...
class Laplace():
    ...
    def solution(self, b, cg = 1, tol = 10**(-8), tri=1):
    ...
    def sol_err(self, b, cg = 1, tol = 10**(-8)):
    ...
    def sol_err_cg_iter(self, b, tol = 10**(-8)):
        ...
        """
        x = self.exact_sol()
        u, u_array = self.solution(b, 1, tol)
